...
//                NameTextOut(MSurface, g_MySelf.m_nSayX, g_MySelf.m_nSayY + 30, g_MySelf.m_nNameColor, clBlack, uname);
      ...
      //g_PlayScene.DrawMiniMap(MSurface); //原来再PlayScn进行绘制的，小地图会被物品名字覆盖  Development 2019-01-11
      FrmDlg.DrawMiniMap.Visible := True; //在FState进行绘制解决小地图被物品名字覆盖  Development 2019-01-11
