...
type
  ...
  //增加麻痹效果支持
  TD3DXAssembleShader = function(const pSrcData; SrcDataLen: LongWord; Flags: DWord; ppConstants: PID3DXBuffer; ppCompiledShader: PID3DXBuffer; ppCompilationErrors: PID3DXBuffer): HResult; stdcall;
...
var
  ...
  //增加麻痹效果支持
  D3DXAssembleShader: TD3DXAssembleShader = nil;
...
begin
  if not Assigned(D3DXSaveSurfaceToFile) then begin
    ...
    //增加麻痹效果支持
    D3DXAssembleShader := JEDI.FindExport('D3DXAssembleShader');
  end;
end;
