...
uses
  ...
  Grobal2, HGE,HGECanvas,HGETextures,
  cliUtil, ClFunc, magiceff, HumanActor, Actor, clEvent;
...
type
  ...
  public
    ...
    procedure DrawChr(dsurface: TDirectDrawSurface; dx, dy: Integer; blend: Boolean; boFlag: Boolean; DrawOnSale: Boolean = False); override;
  end;
  ...
  TBanyaGuardMon = class(TSkeletonArcherMon)
    m_DrawEffect: TDirectDrawSurface;
  protected
  public
    constructor Create; override;
    procedure CalcActorFrame; override;
...
procedure TWhiteSkeleton.DrawChr(dsurface: TDirectDrawSurface; dx, dy: Integer; blend: Boolean; boFlag: Boolean; DrawOnSale: Boolean);
var
  bCanDraw                  : Boolean;
  idx, ax, ay               : Integer;
...
begin
  ...
  if m_boHitEffect and (m_nHitEffectNumber > 0) then begin
    ...
    if d <> nil then DrawBlend(dsurface, dx + ax + m_nShiftX, dy + ay + m_nShiftY, d, 1);
  end;
end;
...
procedure TSkeletonOma.DrawChr(dsurface: TDirectDrawSurface; dx, dy: Integer; blend: Boolean; boFlag: Boolean; DrawOnSale: Boolean);
var
  idx                       : Integer;
  d                         : TDirectDrawSurface;
  ceff                      : TColorEffect;
...
procedure TCatMon.DrawChr(dsurface: TDirectDrawSurface; dx, dy: Integer; blend: Boolean; boFlag: Boolean; DrawOnSale: Boolean);
var
  idx                       : Integer;
  d                         : TDirectDrawSurface;
  ceff                      : TColorEffect;
...
procedure TGasKuDeGi.DrawChr(dsurface: TDirectDrawSurface; dx, dy: Integer; blend: Boolean; boFlag: Boolean; DrawOnSale: Boolean);
var
  idx                       : Integer;
  d                         : TDirectDrawSurface;
  ceff                      : TColorEffect;
...
begin
  ...
  if m_boUseEffect and (m_DrawEffect <> nil) then
    DrawBlend(dsurface, dx + ax + m_nShiftX, dy + ay + m_nShiftY, m_DrawEffect, 1);
end;
...
procedure TSnowMon.DrawChr(dsurface: TDirectDrawSurface; dx, dy: Integer; blend: Boolean; boFlag: Boolean; DrawOnSale: Boolean);
begin
  inherited;
  //if m_sUserName = '' then Exit;  //1015
  if ChrEffect <> nil then
    DrawBlend(dsurface, dx + ax + m_nShiftX, dy + ay + m_nShiftY, ChrEffect, 1);
end;

procedure TSnowMon.DrawEff(dsurface: TDirectDrawSurface; dx, dy: Integer);
var
  idx                       : Integer;
  d                         : TDirectDrawSurface;
  ceff                      : TColorEffect;
...
procedure TAngel.DrawChr(dsurface: TDirectDrawSurface; dx, dy: Integer; blend: Boolean; boFlag: Boolean; DrawOnSale: Boolean);
var
  idx                       : Integer;
  d                         : TDirectDrawSurface;
  wimg                      : TWMImages;
  ...
  if m_boUseMagic and (m_CurMagic.EffectNumber > 0) then begin //sm_spell
    if m_nCurEffFrame in [0..m_nSpellFrame - 1] then begin
      ...
      if wimg <> nil then begin
        ...
        if d <> nil then
          DrawBlend(dsurface, ShiftX + ax2, ShiftY + ay2, d, 1);
      end;
    end;
  end;
...
procedure TTiger.DrawChr(dsurface: TDirectDrawSurface; dx, dy: Integer; blend: Boolean; boFlag: Boolean; DrawOnSale: Boolean);
var
  idx                       : Integer;
  d                         : TDirectDrawSurface;
  ceff                      : TColorEffect;
...
procedure TDragon.DrawChr(dsurface: TDirectDrawSurface; dx, dy: Integer; blend: Boolean; boFlag: Boolean; DrawOnSale: Boolean);
var
  idx                       : Integer;
  d                         : TDirectDrawSurface;
  ceff                      : TColorEffect;
...
procedure TGhostShipMonster.DrawChr(dsurface: TDirectDrawSurface; dx, dy: Integer; blend: Boolean; boFlag: Boolean; DrawOnSale: Boolean);
var
  wimg                      : TWMImages;
  idx                       : Integer;
  d                         : TDirectDrawSurface;
  ...
  if m_boHitEffect then begin
    if (m_nHitEffectNumber > 0) then begin
      ...
      if wimg <> nil then begin
        ...
        if d <> nil then
          DrawBlend(dsurface,ShiftX + tmpx, ShiftY + tmpy, d, 1);
      end;
    end;
  end;
end;
