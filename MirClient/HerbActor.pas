...
uses
  ...
  Grobal2, HGE,HGECanvas,HGETextures,
   cliUtil, magiceff, HumanActor, Actor, WIL;
...
procedure TCastleDoor.DrawChr(dsurface: TDirectDrawSurface; dx, dy: Integer; blend: Boolean; boFlag: Boolean; DrawOnSale: Boolean);
begin
...
procedure TWallStructure.DrawChr(dsurface: TDirectDrawSurface; dx, dy: Integer; blend: Boolean; boFlag: Boolean; DrawOnSale: Boolean);
begin
...
procedure TDragonBody.DrawEff(dsurface: TDirectDrawSurface; dx, dy: Integer);
begin
