...
uses
  Windows, Graphics, DirectXD3D9, HGEBase, HGE, HGETextures, HGEFonts,GfxFont;
...
type
  ...
  private
    ...
    procedure SetPattern2(Texture: ITexture; Rect: TRect);
  ...
  public
    ...
    procedure DrawPart(Texture: ITexture; X, Y, SrcX, SrcY, Width, Height, ScaleX, ScaleY, CenterX, CenterY: Single; Color: Cardinal; BlendMode: Integer); overload;
    procedure DrawPart(Texture: ITexture; X, Y, SrcX, SrcY, Width, Height: Single; Color: Cardinal; BlendMode: Integer); overload;
    procedure DrawPart2(Texture: ITexture; X, Y, SrcX, SrcY, Width, Height, ScaleX, ScaleY, CenterX, CenterY: Single; Color: Cardinal; BlendMode: Integer); overload;
    procedure DrawPart2(Texture: ITexture; X, Y, SrcX, SrcY, Width, Height: Single; Color: Cardinal; BlendMode: Integer); overload;
    procedure DrawPartGrayScale(Texture: ITexture; X, Y, SrcX, SrcY, Width, Height: Integer; Color: Cardinal; BlendMode: Integer);
    procedure DrawExLight(Texture: TDXTexture; X, Y, CenterX, CenterY, ScaleX, ScaleY: Single; Color: Cardinal; BlendMode: Integer); overload;
    procedure DrawZoom(Texture: TDXTexture; X, Y, CenterX, CenterY, ScaleX, ScaleY: Single; Color: Cardinal; BlendMode: Integer); overload;
    procedure DrawZoom(Texture: TDXTexture; X, Y, ScaleX, ScaleY: Single; Color: Cardinal; BlendMode: Integer); overload;
    procedure DrawColorZoom(Texture: TDXTexture; X, Y, CenterX, CenterY, ScaleX, ScaleY: Single; Color: Cardinal; BlendMode: Integer); overload;
    procedure DrawColorZoom(Texture: TDXTexture; X, Y, ScaleX, ScaleY: Single; Color: Cardinal; BlendMode: Integer); overload;
    procedure DrawWaveX(Texture: ITexture; X, Y, Width, Height: Integer; Amp, Len, Phase: Integer; BlendMode: Integer; Color: LongWord = $FFFFFFFF); overload;
    procedure DrawWaveX(Texture: TDXTexture; X, Y, Width, Height: Integer; Amp, Len, Phase: Integer; BlendMode: Integer; Color: LongWord = $FFFFFFFF); overload;
    procedure DrawWaveY(Texture: ITexture; X, Y, Width, Height: Integer; Amp, Len, Phase: Integer; BlendMode: Integer; Color: LongWord = $FFFFFFFF);  overload;
    procedure DrawWaveY(Texture: TDXTexture; X, Y, Width, Height: Integer; Amp, Len, Phase: Integer; BlendMode: Integer; Color: LongWord = $FFFFFFFF);  overload;
    //新字体

    procedure DrawFont(Str: WideString; x, y: Integer; HaveBackGround{是否有背景}: Boolean;
                      BackGroundColor{背景颜色}: LongWord; Haveshadow{是否有阴影}: Boolean;Color: LongWord; show: Boolean); overload;
  ...
  public
    ...
    procedure TextBoldOut(x, Y: Integer; Str: WideString; FColor, BColor: Cardinal; Alpha: Byte); overload;
    procedure TextOutX( x, y: Integer; FColor: Cardinal;Str: WideString);  overload;
    procedure TextOutX( x, y: Integer; Str: WideString; FColor: Cardinal); overload;
    procedure TextOutX( x, y: Integer; Str: WideString; FColor: Cardinal; BColor: Cardinal); overload;
...
begin
  ...
  Font_Default_H := TGfxFont.Create('宋体', 12, True, False, False);
...
procedure TDXDrawCanvas.TextOutX( x, y: Integer; FColor: Cardinal;Str: WideString);
begin
  DrawFont( Str, x, y, false, 0, false, FColor, false);
end;
procedure TDXDrawCanvas.TextOutX( x, y: Integer;Str: WideString; FColor: Cardinal);
begin
  DrawFont( Str, x, y, false, 0, false, FColor, false);
end;
procedure TDXDrawCanvas.TextOutX( x, y: Integer;Str: WideString; FColor: Cardinal; BColor: Cardinal);
begin
  DrawFont( Str, x, y, True, BColor, false, FColor, false);
end;

procedure TDXCanvas.DrawFont(Str: WideString; x, y: Integer; HaveBackGround: Boolean;
...
procedure TDXCanvas.DrawFont_H(Str: WideString; x, y: Integer; HaveBackGround: Boolean;
BackGroundColor: LongWord; Haveshadow: Boolean; Color: LongWord; show: Boolean);
var
  OldColor: LongWord;
begin
...
procedure TDXCanvas.DrawExLight(Texture: TDXTexture; X, Y, CenterX, CenterY, ScaleX, ScaleY: Single; Color: Cardinal; BlendMode: Integer);
var
  TempX1, TempY1, TempX2, TempY2: Single;
begin
  SetPattern(Texture.Image, Texture.ClientRect);
...
procedure TDXCanvas.DrawZoom(Texture: TDXTexture; X, Y, CenterX, CenterY, ScaleX, ScaleY: Single; Color: Cardinal; BlendMode: Integer);
var
  TempX1, TempY1, TempX2, TempY2: Single;
begin
  SetPattern(Texture.Image, Texture.ClientRect);
...
procedure TDXCanvas.DrawZoom(Texture: TDXTexture; X, Y, ScaleX, ScaleY: Single; Color: Cardinal; BlendMode: Integer);
begin
  if Texture = nil then exit;
  DrawZoom(Texture, X, Y, 0, 0, ScaleX, ScaleY, Color, BlendMode);
end;

procedure TDXCanvas.DrawColorZoom(Texture: TDXTexture; X, Y, CenterX, CenterY, ScaleX, ScaleY: Single; Color: Cardinal; BlendMode: Integer);
var
  TempX1, TempY1, TempX2, TempY2: Single;
begin
  SetPattern(Texture.Image, Texture.ClientRect);
...
procedure TDXCanvas.DrawColorZoom(Texture: TDXTexture; X, Y, ScaleX, ScaleY: Single; Color: Cardinal; BlendMode: Integer);
begin
  if Texture = nil then exit;
  DrawColorZoom(Texture, X, Y, 0, 0, ScaleX, ScaleY, Color, BlendMode);
end;

procedure TDXCanvas.DrawPart(Texture: ITexture; X, Y, SrcX, SrcY, Width, Height,
      ScaleX, ScaleY, CenterX, CenterY: Single; Color: Cardinal; BlendMode: Integer);
var
...
procedure TDXCanvas.DrawPart(Texture: ITexture; X, Y, SrcX, SrcY, Width, Height: Single;
   Color: Cardinal; BlendMode: Integer);
begin
  DrawPart(Texture,X, Y, SrcX, SrcY, Width, Height, 1, 1, 0, 0, Color, BlendMode);
end;

procedure TDXCanvas.DrawPart2(Texture: ITexture; X, Y, SrcX, SrcY, Width, Height,
      ScaleX, ScaleY, CenterX, CenterY: Single; Color: Cardinal; BlendMode: Integer);
var
  TexX1, TexY1, TexX2, TexY2: Single;
  TempX1, TempY1, TempX2, TempY2: Single;
...
procedure TDXCanvas.DrawPart2(Texture: ITexture; X, Y, SrcX, SrcY, Width, Height: Single;
   Color: Cardinal; BlendMode: Integer);
begin
  DrawPart2(Texture,X, Y, SrcX, SrcY, Width, Height, 1, 1, 0, 0, Color, BlendMode);
end;

procedure TDXCanvas.DrawPartGrayScale(Texture: ITexture; X, Y, SrcX, SrcY, Width, Height: Integer; Color: Cardinal; BlendMode: Integer);
{var
 PSrcTex: PLongWord;
 Px,Qx: Longword;
 i,j,jj: Integer;
...
begin
 { Try
    PSrcTex := FHGE.Texture_Lock(Texture, True, 0, 0, Width, Height);
     for j:= 0 to Height - 1 do  begin
        for i:= 0 to Width - 1 do  begin
           ...
           Qx := ARGB(255, Gr, Gr, Gr);
           //PSrcTex^:= Qx;
          // Inc(PSrcTex);
        end;
     end;
  Finally
    FHGE.Texture_Unlock(Texture);
  End; }
  DrawPart2(Texture,X, Y, SrcX, SrcY, Width, Height, 1, 1, 0, 0, Color, BlendMode);
end;
...
procedure TDXCanvas.SetPattern2(Texture: ITexture; Rect: TRect);
var
  TexX1, TexY1, TexX2, TexY2: Single;
  Left, Top: Integer;
begin
...
procedure TDXCanvas.DrawWaveX(Texture: ITexture; X, Y, Width, Height: Integer; Amp, Len,
      Phase: Integer; BlendMode: Integer; Color: LongWord);
var
  I, J, CWidth: Integer;
begin
  ...
  if CWidth > 0 then
    for J := 0 to Width  do  begin
      I:=Trunc(J * CWidth / Width);
      DrawPart(Texture, X + J, Y + Amp * Sin((Phase + J) * PI * Width / Len / 256),
             I, 0, 1, Height, Color, BlendMode);
    end;
end;

procedure TDXCanvas.DrawWaveX(Texture: TDXTexture; X, Y, Width, Height: Integer; Amp, Len,
       Phase: Integer; BlendMode: Integer; Color: LongWord);
begin
   DrawWaveX(Texture.Image, X, Y, Width, Height, Amp, Len, Phase, BlendMode,Color);
end;

procedure TDXCanvas.DrawWaveY(Texture: ITexture; X, Y, Width, Height: Integer; Amp, Len,
       Phase: Integer; BlendMode: Integer; Color: LongWord);
var
  I, J, CHeight: Integer;
begin
  ...
  if CHeight > 0 then
    for J := 0 to Height do  begin
     I:=Trunc(J * CHeight / Height);
     DrawPart(Texture, X + Amp * Sin((Phase + J) * PI * Height / Len / 256), Y + J,
             0, I, Width, 1, Color, BlendMode);
    end;
end;

procedure TDXCanvas.DrawWaveY(Texture: TDXTexture; X, Y, Width, Height: Integer; Amp, Len,
       Phase: Integer; BlendMode: Integer; Color: LongWord);
begin
  DrawWaveY(Texture.Image, X, Y, Width, Height, Amp, Len, Phase, BlendMode,Color);
end;       
...
procedure TDXDrawCanvas.Draw(X, Y: Integer; SrcRect: TRect; Source: TDXTexture; Color, DrawFx: Cardinal);
begin
  if Source = nil then exit;
  DrawRect(Source, X, Y, SrcRect, DrawFx, Color);
end;
...
var
  ...
  nWidth: Integer;
begin
  if (FFont = nil) or (not FFont.boInitialize) or (Str = '') then exit;
  nWidth := 0;
  Dec(X);
  Dec(Y);
...
procedure TDXDrawCanvas.TextBoldOut(x, Y: Integer; Str: WideString; FColor, BColor: Cardinal; Alpha: Byte);
var
  i: integer;
  sWord: Word;
  Texture: TDXTexture;
...
begin
  ...
  for I := 1 to Length(Str) do begin
    ...
    AsciiRect := Font.AsciiRect[sWord];
    if (AsciiRect.Right > 4) then begin
      DrawRect(Texture, X + nWidth - 1, Y, AsciiRect.Left, AsciiRect.Top, AsciiRect.Right, AsciiRect.Bottom, fxBlend, (Alpha shl 24) or BColor);
      DrawRect(Texture, X + nWidth + 1, Y, AsciiRect.Left, AsciiRect.Top, AsciiRect.Right, AsciiRect.Bottom, fxBlend, (Alpha shl 24) or BColor);
      DrawRect(Texture, X + nWidth, Y - 1, AsciiRect.Left, AsciiRect.Top, AsciiRect.Right, AsciiRect.Bottom, fxBlend, (Alpha shl 24) or BColor);
      DrawRect(Texture, X + nWidth, Y + 1, AsciiRect.Left, AsciiRect.Top, AsciiRect.Right, AsciiRect.Bottom, fxBlend, (Alpha shl 24) or BColor);
      DrawRect(Texture, X + nWidth, Y, AsciiRect.Left, AsciiRect.Top, AsciiRect.Right, AsciiRect.Bottom, fxBlend, (Alpha shl 24) or FColor);
      Inc(nWidth, (AsciiRect.Right - AsciiRect.Left) + Font.kerning);
    end;
