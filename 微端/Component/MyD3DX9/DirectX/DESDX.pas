...
procedure EncryBuffer(Key: string; Source, Dest: PAnsiChar; nSourceLen, nDestLen: Integer);
procedure DecryBuffer(Key: string; Source, Dest: PAnsiChar; nSourceLen, nDestLen: Integer);
