...
uses
  Windows, Messages, SysUtils, Classes, Controls, Forms, ExtCtrls, MMSystem, DirectXWave, DirectXSound, HGEBase;
...
procedure Register;
begin
  RegisterComponents('HGEDirect', [TDXSound]);
end;
...
constructor TControlSubClass.Create(Control: TControl; WindowProc: TControlSubClassProc);
begin
  inherited Create;
  FControl := Control;
