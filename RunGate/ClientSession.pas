...
//    m_StartTick: LongWord;
    ...
    procedure ProcessCltData(const Addr: Integer; const Len: Integer; var Succeed: BOOL);
...
procedure TSessionObj.ProcessCltData(const Addr, Len: Integer; var Succeed: BOOL);
var
