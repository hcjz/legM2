...
resourcestring
  sVersion                  = '程序版本: 1.00 Build 2019/01/25';
  sUpdate                   = '更新日期: 2019/01/25';
  sPrograme                 = '程序制作: QQ:8302775';
  sOwen                     = 'LEGEND';
  sWebSite                  = '程序网站: http://www.legendm2.com';
  SBBsSite                  = '程序论坛: http://www.legendm2.com';
...
var
  g_Config                  : TConfig = (
    ...
    nLockIdTick: 60 * 1000;
    sSQLHost: '(LOCAL)';
    sSQLDatabase: 'LEGENDOFMIR';
    sSQLUserName: 'legendm2';
    sSQLPassword: '123456';
    CLPort: 3009;
    CLPwd: 12345;
    CLOpen: False;
