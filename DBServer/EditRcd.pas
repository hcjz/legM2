...
begin
  ...
  else if Sender = EditMasterName then begin
  ...
  else if Sender = EditCurMap then begin
  ...
  else if Sender = EditGamePoint then begin
    m_ChrRcd.Data.nGamePoint := EditGamePoint.Value;
  end
  else if Sender = EditPayPoint then begin
  ...
  else if Sender = EditContribution then begin
