...
var
  ...
  g_sNoticeUrl              : string = 'http://www.legendm2.com';
...
begin
  with frmMain do begin
    ...
    for i := 0 to g_IniConf.ReadInteger('Text2CleanUp', 'Count', 0) - 1 do begin
      s := g_IniConf.ReadString('Text2CleanUp', format('TextFile%d', [i]), '');
      //if FileExists(s) then
      addToTextClearList(s);
    end;

    for i := 0 to g_IniConf.ReadInteger('Text2Delete', 'Count', 0) - 1 do begin
