...
uses
  ...
  Controls, Forms, Dialogs, StdCtrls,Grobal2, BusinessSkinForm,DBTMain,
  bsSkinCtrls;
type
  TFrmUserInfoEdit=class(TForm)
    ...
    CkFullEdit: TbsSkinCheckRadioBox;
...
procedure TFrmUserInfoEdit.bsSkinSpeedButton2Click(Sender: TObject);
begin
