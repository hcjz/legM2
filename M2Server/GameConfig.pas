...
uses M2Share, HUtil32, ActionSpeedConfig;
...
begin
  if SpinEditLimitLevel.Text = '' then begin
...
begin
  if SpinEditKillMonExpDiv.Text = '' then begin
...
begin
  if EditNoDropItemGamegold.Text = '' then begin
...
begin
  if EditNoScatterBagGamegold.Text = '' then begin
