...
begin
  if Application.MessageBox('是否确认初始化全局变量I？', '确认信息', MB_YESNO + MB_ICONQUESTION) = IDYES then begin
...
begin
  if Application.MessageBox('是否确认初始化全局变量H？', '确认信息', MB_YESNO + MB_ICONQUESTION) = IDYES then begin
...
begin
  if Application.MessageBox('是否确认初始化全局变量G？', '确认信息', MB_YESNO + MB_ICONQUESTION) = IDYES then begin
...
begin
  if Application.MessageBox('是否确认初始化全局变量S？', '确认信息', MB_YESNO + MB_ICONQUESTION) = IDYES then begin
