        ...
        case pload.loadType of
          LOADTYPE_REQGETLIST: begin
              ...
              if pSearchInfo <> nil then begin
                ...
                g_UMDEBUG := 21;
                if g_DBSQL = nil then MainOutMessageAPI('[Exception] g_DBSql = nil');
                ...
                if g_UMDEBUG > 0 then MainOutMessageAPI('[TestCode]ExecuteLoadCommand : pSearchInfo = nil' + IntToStr(loadType) + ' [' + IntToStr(g_UMDEBUG) + ']');
                g_UMDEBUG := 15;
              end;
            end;
