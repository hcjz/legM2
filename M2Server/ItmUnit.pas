...
var
  ...
  ps                        : pTStdItem;
begin
  if g_Config.boAddValEx then begin
    nC := GetRandomRange(5, 40);
    if Random(45) = 0 then UserItem.btValue[15] := _MIN(15, nC + 1) * 16 + UserItem.btValue[15] mod 16;
    nC := GetRandomRange(5, 40);
    if Random(45) = 0 then UserItem.btValue[15] := UserItem.btValue[15] div 16 * 16 + _MIN(15, nC + 1);

    nC := GetRandomRange(5, 40);
    if Random(45) = 0 then UserItem.btValue[16] := _MIN(15, nC + 1) * 16 + UserItem.btValue[16] mod 16;
    nC := GetRandomRange(5, 40);
    if Random(45) = 0 then UserItem.btValue[16] := UserItem.btValue[16] div 16 * 16 + _MIN(15, nC + 1);

    nC := GetRandomRange(5, 40);
    if Random(45) = 0 then UserItem.btValue[17] := _MIN(15, nC + 1) * 16 + UserItem.btValue[17] mod 16;
    nC := GetRandomRange(5, 40);
    if Random(45) = 0 then UserItem.btValue[17] := UserItem.btValue[17] div 16 * 16 + _MIN(15, nC + 1);
  end;
...
begin
  if g_Config.boAddValEx then begin
    nC := GetRandomRange(5, 40);
    if Random(55) = 0 then UserItem.btValue[15] := _MIN(15, nC + 1) * 16 + UserItem.btValue[15] mod 16;
    nC := GetRandomRange(5, 40);
    if Random(55) = 0 then UserItem.btValue[15] := UserItem.btValue[15] div 16 * 16 + _MIN(15, nC + 1);

    nC := GetRandomRange(5, 40);
    if Random(55) = 0 then UserItem.btValue[16] := _MIN(15, nC + 1) * 16 + UserItem.btValue[16] mod 16;
    nC := GetRandomRange(5, 40);
    if Random(55) = 0 then UserItem.btValue[16] := UserItem.btValue[16] div 16 * 16 + _MIN(15, nC + 1);

    nC := GetRandomRange(5, 40);
    if Random(55) = 0 then UserItem.btValue[17] := _MIN(15, nC + 1) * 16 + UserItem.btValue[17] mod 16;
    nC := GetRandomRange(5, 40);
    if Random(55) = 0 then UserItem.btValue[17] := UserItem.btValue[17] div 16 * 16 + _MIN(15, nC + 1);
  end;
...
begin
  case StdItem.stdMode of
    ...
    15..24, 26, 27, 28, 29, 30, 51, 52, 53, 54, 62, 63, 64: begin
        StdItem.AC := MakeLong(LoWord(StdItem.AC), HiWord(StdItem.AC) + UserItem.btValue[0]);
        StdItem.MAC := MakeLong(LoWord(StdItem.MAC), HiWord(StdItem.MAC) + UserItem.btValue[1]);
        StdItem.DC := MakeLong(LoWord(StdItem.DC), HiWord(StdItem.DC) + UserItem.btValue[2]);
        StdItem.MC := MakeLong(LoWord(StdItem.MC), HiWord(StdItem.MC) + UserItem.btValue[3]);
        ...
        for i := 0 to 2 do begin
          if (StdItem.reserve[0 + i] > 0) or (UserItem.btValue[15 + i] > 0) then begin
...
begin
  ...
  nC := GetRandomRange(RandomAddValue.abAddValueMaxLimit[5], RandomAddValue.abAddValueRate[5]);
  if RandomAddValue.nAddValueRate >= (Random(100) + 1) then UserItem.btValue[5] := nC;

  nC := GetRandomRange(RandomAddValue.abAddValueMaxLimit[6], RandomAddValue.abAddValueRate[6]);
  if RandomAddValue.nAddValueRate >= (Random(100) + 1) then UserItem.btValue[6] := nC;

  nC := GetRandomRange(RandomAddValue.abAddValueMaxLimit[7], RandomAddValue.abAddValueRate[7]);
  if RandomAddValue.nAddValueRate >= (Random(100) + 1) then UserItem.btValue[7] := nC;
...
begin
  ...
  for i := 0 to 15 do begin
    r := Random(16);
    case r of
      0: if (g_Config.tiAbilTagDropAddRate <> 0) and (Random(_Max(1, g_Config.tiAbilTagDropAddRate - Eva.EvaTimes)) = 0) then begin
      ...
      1: if (g_Config.tiAbilPreDropAddRate <> 0) and (Random(_Max(1, g_Config.tiAbilPreDropAddRate - Eva.EvaTimes)) = 0) then begin
      ...
      2: if (g_Config.tiAbilSuckAddRate <> 0) and (Random(_Max(1, g_Config.tiAbilSuckAddRate - Eva.EvaTimes)) = 0) then begin
      ...
      3: if (g_Config.tiAbilIpRecoverAddRate <> 0) and (Random(_Max(1, g_Config.tiAbilIpRecoverAddRate - Eva.EvaTimes)) = 0) then begin
      ...
      4: if (g_Config.tiAbilIpExAddRate <> 0) and (Random(_Max(1, g_Config.tiAbilIpExAddRate - Eva.EvaTimes)) = 0) then begin
      ...
      5: if (g_Config.tiAbilIpDamAddRate <> 0) and (Random(_Max(1, g_Config.tiAbilIpDamAddRate - Eva.EvaTimes)) = 0) then begin
      ...
      6: if (g_Config.tiAbilIpReduceAddRate <> 0) and (Random(_Max(1, g_Config.tiAbilIpReduceAddRate - Eva.EvaTimes)) = 0) then begin
      ...
      7: if (g_Config.tiAbilIpDecAddRate <> 0) and (Random(_Max(1, g_Config.tiAbilIpDecAddRate - Eva.EvaTimes)) = 0) then begin
      ...
      8: if (g_Config.tiAbilBangAddRate <> 0) and (Random(_Max(1, g_Config.tiAbilBangAddRate - Eva.EvaTimes)) = 0) then begin
      ...
      9: if (g_Config.tiAbilGangUpAddRate <> 0) and (Random(_Max(1, g_Config.tiAbilGangUpAddRate - Eva.EvaTimes)) = 0) then begin
      ...
      10: if (g_Config.tiAbilPalsyReduceAddRate <> 0) and (Random(_Max(1, g_Config.tiAbilPalsyReduceAddRate - Eva.EvaTimes)) = 0) then begin
      ...
      11: if (g_Config.tiAbilHPExAddRate <> 0) and (Random(_Max(1, g_Config.tiAbilHPExAddRate - Eva.EvaTimes)) = 0) then begin
      ...
      12: if (g_Config.tiAbilMPExAddRate <> 0) and (Random(_Max(1, g_Config.tiAbilMPExAddRate - Eva.EvaTimes)) = 0) then begin
      ...
      13: if (g_Config.tiAbilCCAddRate <> 0) and (Random(_Max(1, g_Config.tiAbilCCAddRate - Eva.EvaTimes)) = 0) then begin
      ...
      14: if (g_Config.tiAbilPoisonReduceAddRate <> 0) and (Random(_Max(1, g_Config.tiAbilPoisonReduceAddRate - Eva.EvaTimes)) = 0) then begin
      ...
      15: if (g_Config.tiAbilPoisonRecoverAddRate <> 0) and (Random(_Max(1, g_Config.tiAbilPoisonRecoverAddRate - Eva.EvaTimes)) = 0) then begin
...
begin
  ...
  try
    for i := 0 to 7 do begin
      rr := Random(110);
      case rr of
        0..19: if (g_Config.tiWeaponDCAddRate <> 0) and (Random(_Max(1, g_Config.tiWeaponDCAddRate - Eva.EvaTimes)) = 0) then begin
            nC := GetRandomRange(g_Config.tiWeaponDCAddValueMaxLimit, _Max(1, g_Config.tiWeaponDCAddValueRate - Eva.EvaTimes * 2));
            if nC > 0 then begin
              Abil[n].btType := 1;      //mob
              Abil[n].btValue := nC;
              Inc(n);
              if g_Config.tiPutAbilOnce or (n > High(Abil)) then begin
                Result := 1;
                Exit;
              end;
            end;
        ...
        20..39: if (g_Config.tiWeaponMCAddRate <> 0) and (Random(_Max(1, g_Config.tiWeaponMCAddRate - Eva.EvaTimes)) = 0) then begin
        ...
        40..59: if (g_Config.tiWeaponSCAddRate <> 0) and (Random(_Max(1, g_Config.tiWeaponSCAddRate - Eva.EvaTimes)) = 0) then begin
        ...
        100..109: if (g_Config.tiWeaponLuckAddRate <> 0) and (Random(_Max(1, g_Config.tiWeaponLuckAddRate - Eva.EvaTimes)) = 0) then begin
        ...
        60..69: if (g_Config.tiWeaponCurseAddRate <> 0) and (Random(_Max(1, g_Config.tiWeaponCurseAddRate - Eva.EvaTimes)) = 0) then begin
        ...
        70..79: if (g_Config.tiWeaponHitAddRate <> 0) and (Random(_Max(1, g_Config.tiWeaponHitAddRate - Eva.EvaTimes)) = 0) then begin
        ...
        80..89: if (g_Config.tiWeaponHitSpdAddRate <> 0) and (Random(_Max(1, g_Config.tiWeaponHitSpdAddRate - Eva.EvaTimes)) = 0) then begin
        ...
        90..99: if (g_Config.tiWeaponHolyAddRate <> 0) and (Random(_Max(1, g_Config.tiWeaponHolyAddRate - Eva.EvaTimes)) = 0) then begin
    ...
    //神秘
    if (g_Config.tiSecretPropertyAddRate <> 0) and (Random(_Max(1, g_Config.tiSecretPropertyAddRate - Eva.EvaTimes)) = 0) then begin
    ...
    //灵媒
    if (g_Config.tiSpiritAddRate <> 0) and (Random(_Max(1, g_Config.tiSpiritAddRate - Eva.EvaTimes)) = 0) then begin
    ...
    if n < 3 then begin
      if not g_Config.tiPutAbilOnce or (n = 0) then begin
...
var
  i, ii, t, n, r, rr, rrr, nC, n10, n14: Integer;
  Eva                       : TEvaluation;
  Abil                      : array[0..3] of TEvaAbil;
begin
  Result := 0;
  ...
  try
    for i := 0 to 3 do begin
      rr := Random(100);
      case rr of
        0..29: if (g_Config.tiWearingDCAddRate <> 0) and (Random(_Max(1, g_Config.tiWearingDCAddRate - Eva.EvaTimes)) = 0) then begin
        ...
        30..59: if (g_Config.tiWearingMCAddRate <> 0) and (Random(_Max(1, g_Config.tiWearingMCAddRate - Eva.EvaTimes)) = 0) then begin
        ...
        60..89: if (g_Config.tiWearingSCAddRate <> 0) and (Random(_Max(1, g_Config.tiWearingSCAddRate - Eva.EvaTimes)) = 0) then begin
        ...
        90..99: if stdMode in [19, 20, 21, 23, 24] then begin //特殊首饰
            if stdMode = 19 then begin
              for ii := 0 to 1 do begin
                rrr := Random(2);
                case rrr of
                  0: if (g_Config.tiWearingAntiMagicAddRate <> 0) and (Random(_Max(1, g_Config.tiWearingAntiMagicAddRate - Eva.EvaTimes)) = 0) then begin
                  ...
                  1: if (g_Config.tiWearingLuckAddRate <> 0) and (Random(_Max(1, g_Config.tiWearingLuckAddRate - Eva.EvaTimes)) = 0) then begin
            ...
            end else if stdMode in [20, 24] then begin
              for ii := 0 to 1 do begin
                rrr := Random(2);
                case rrr of
                  0: if (g_Config.tiWearingHitAddRate <> 0) and (Random(_Max(1, g_Config.tiWearingHitAddRate - Eva.EvaTimes)) = 0) then begin
                  ...
                  1: if (g_Config.tiWearingSpeedAddRate <> 0) and (Random(_Max(1, g_Config.tiWearingSpeedAddRate - Eva.EvaTimes)) = 0) then begin
            ...
            end else if stdMode in [21] then begin
              for ii := 0 to 1 do begin
                rrr := Random(2);
                case rrr of
                  0: if (g_Config.tiWearingHealthRecoverAddRate <> 0) and (Random(_Max(1, g_Config.tiWearingHealthRecoverAddRate - Eva.EvaTimes)) = 0) then begin
                  ...
                  1: if (g_Config.tiWearingSpellRecoverAddRate <> 0) and (Random(_Max(1, g_Config.tiWearingSpellRecoverAddRate - Eva.EvaTimes)) = 0) then begin
            ...
            end else if stdMode in [23] then begin
              for ii := 0 to 1 do begin
                rrr := Random(2);
                case rrr of
                  0: if (g_Config.tiWearingHealthRecoverAddRate <> 0) and (Random(_Max(1, g_Config.tiWearingHealthRecoverAddRate - Eva.EvaTimes)) = 0) then begin
            ...
            for ii := 0 to 1 do begin
              rrr := Random(2);
              case rrr of
                0: if (g_Config.tiWearingACAddRate <> 0) and (Random(_Max(1, g_Config.tiWearingACAddRate - Eva.EvaTimes)) = 0) then begin
                ...
                1: if (g_Config.tiWearingMACAddRate <> 0) and (Random(_Max(1, g_Config.tiWearingMACAddRate - Eva.EvaTimes)) = 0) then begin
...
begin
  n := -1;
  Result := 0;
  if g_Config.tiSpMagicAddAtFirst then begin
    t := 0;
    ...
    try
      for i := 0 to 7 - G_SpSkillRet do begin
        ...
        if (btAdvAbil and (1 shl r) <> 0) then
          Break;
        case r of
          0: if (g_Config.tiSpMagicAddRate1 <> 0) and (Random(g_Config.tiSpMagicAddRate1) = 0) then begin
              btAdvAbil := btAdvAbil or (1 shl r);
              Result := 100;
              Exit;
            end;
          1: if (g_Config.tiSpMagicAddRate2 <> 0) and (Random(g_Config.tiSpMagicAddRate2) = 0) then begin
              btAdvAbil := btAdvAbil or (1 shl r);
              Result := 101;
              Exit;
            end;
          2: if (g_Config.tiSpMagicAddRate3 <> 0) and (Random(g_Config.tiSpMagicAddRate3) = 0) then begin
              btAdvAbil := btAdvAbil or (1 shl r);
              Result := 102;
              Exit;
            end;
          3: if (g_Config.tiSpMagicAddRate4 <> 0) and (Random(g_Config.tiSpMagicAddRate4) = 0) then begin
              btAdvAbil := btAdvAbil or (1 shl r);
              Result := 103;
              Exit;
            end;
          4: if (g_Config.tiSpMagicAddRate5 <> 0) and (Random(g_Config.tiSpMagicAddRate5) = 0) then begin
              btAdvAbil := btAdvAbil or (1 shl r);
              Result := 104;
              Exit;
            end;
          5: if (g_Config.tiSpMagicAddRate6 <> 0) and (Random(g_Config.tiSpMagicAddRate6) = 0) then begin
              btAdvAbil := btAdvAbil or (1 shl r);
              Result := 105;
              Exit;
            end;
          6: if (g_Config.tiSpMagicAddRate7 <> 0) and (Random(g_Config.tiSpMagicAddRate7) = 0) then begin
              btAdvAbil := btAdvAbil or (1 shl r);
              Result := 106;
              Exit;
            end;
          7: if (g_Config.tiSpMagicAddRate8 <> 0) and (Random(g_Config.tiSpMagicAddRate8) = 0) then begin
              btAdvAbil := btAdvAbil or (1 shl r);
              Result := 107;
              Exit;
            end;
    ...
    n := -1;
    for i := 0 to 3 do begin
      if Abil[i].btValue = 0 then begin
        n := i;
        Break;
      end;
    end;
    ...
    if n >= 0 then begin
      for i := 0 to 15 do begin
        r := Random(16);
        case r of
          0: if (g_Config.tiAbilTagDropAddRate <> 0) and (Random(_Max(1, g_Config.tiAbilTagDropAddRate - bLevel)) = 0) then begin
          ...
          1: if (g_Config.tiAbilPreDropAddRate <> 0) and (Random(_Max(1, g_Config.tiAbilPreDropAddRate - bLevel)) = 0) then begin
          ...
          2: if (g_Config.tiAbilSuckAddRate <> 0) and (Random(_Max(1, g_Config.tiAbilSuckAddRate - bLevel)) = 0) then begin
          ...
          3: if (g_Config.tiAbilIpRecoverAddRate <> 0) and (Random(_Max(1, g_Config.tiAbilIpRecoverAddRate - bLevel)) = 0) then begin
          ...
          4: if (g_Config.tiAbilIpExAddRate <> 0) and (Random(_Max(1, g_Config.tiAbilIpExAddRate - bLevel)) = 0) then begin
          ...
          5: if (g_Config.tiAbilIpDamAddRate <> 0) and (Random(_Max(1, g_Config.tiAbilIpDamAddRate - bLevel)) = 0) then begin
          ...
          6: if (g_Config.tiAbilIpReduceAddRate <> 0) and (Random(_Max(1, g_Config.tiAbilIpReduceAddRate - bLevel)) = 0) then begin
          ...
          7: if (g_Config.tiAbilIpDecAddRate <> 0) and (Random(_Max(1, g_Config.tiAbilIpDecAddRate - bLevel)) = 0) then begin
          ...
          8: if (g_Config.tiAbilBangAddRate <> 0) and (Random(_Max(1, g_Config.tiAbilBangAddRate - bLevel)) = 0) then begin
          ...
          9: if (g_Config.tiAbilGangUpAddRate <> 0) and (Random(_Max(1, g_Config.tiAbilGangUpAddRate - bLevel)) = 0) then begin
          ...
          10: if (g_Config.tiAbilPalsyReduceAddRate <> 0) and (Random(_Max(1, g_Config.tiAbilPalsyReduceAddRate - bLevel)) = 0) then begin
          ...
          11: if (g_Config.tiAbilHPExAddRate <> 0) and (Random(_Max(1, g_Config.tiAbilHPExAddRate - bLevel)) = 0) then begin
          ...
          12: if (g_Config.tiAbilMPExAddRate <> 0) and (Random(_Max(1, g_Config.tiAbilMPExAddRate - bLevel)) = 0) then begin
          ...
          13: if (g_Config.tiAbilCCAddRate <> 0) and (Random(_Max(1, g_Config.tiAbilCCAddRate - bLevel)) = 0) then begin
          ...
          14: if (g_Config.tiAbilPoisonReduceAddRate <> 0) and (Random(_Max(1, g_Config.tiAbilPoisonReduceAddRate - bLevel)) = 0) then begin
          ...
          15: if (g_Config.tiAbilPoisonRecoverAddRate <> 0) and (Random(_Max(1, g_Config.tiAbilPoisonRecoverAddRate - bLevel)) = 0) then begin
    ...
    try
      for i := 0 to 6 do begin
        ...
        if (btAdvAbil and (1 shl r) <> 0) then
          Break;
        case r of
          0: if (g_Config.tiSpecialSkills1AddRate <> 0) and (Random(g_Config.tiSpecialSkills1AddRate) = 0) then begin
              btAdvAbil := btAdvAbil or (1 shl r);
              Inc(Result);
              Exit;
            end;
          1: if (g_Config.tiSpecialSkills2AddRate <> 0) and (Random(g_Config.tiSpecialSkills2AddRate) = 0) then begin
              btAdvAbil := btAdvAbil or (1 shl r);
              Inc(Result);
              Exit;
            end;
          2: if (g_Config.tiSpecialSkills3AddRate <> 0) and (Random(g_Config.tiSpecialSkills3AddRate) = 0) then begin
              btAdvAbil := btAdvAbil or (1 shl r);
              Inc(Result);
              Exit;
            end;
          3: if (g_Config.tiSpecialSkills4AddRate <> 0) and (Random(g_Config.tiSpecialSkills4AddRate) = 0) then begin
              btAdvAbil := btAdvAbil or (1 shl r);
              Inc(Result);
              Exit;
            end;
          4: if (g_Config.tiSpecialSkills5AddRate <> 0) and (Random(g_Config.tiSpecialSkills5AddRate) = 0) then begin
              btAdvAbil := btAdvAbil or (1 shl r);
              Inc(Result);
              Exit;
            end;
          5: if (g_Config.tiSpecialSkills6AddRate <> 0) and (Random(g_Config.tiSpecialSkills6AddRate) = 0) then begin
              btAdvAbil := btAdvAbil or (1 shl r);
              Inc(Result);
              Exit;
            end;
          6: if (g_Config.tiSpecialSkills7AddRate <> 0) and (Random(g_Config.tiSpecialSkills7AddRate) = 0) then begin
              btAdvAbil := btAdvAbil or (1 shl r);
              Inc(Result);
              Exit;
            end;
...
var
  i, t, n, r, nC, n10, n14, rr, cnt: Integer;
  //Eva                       : TEvaluation;
  Abil                      : array[0..3] of TEvaAbil;
begin
  ...
  try
    if n >= 0 then begin
      for i := 0 to 7 do begin
        rr := Random(100);
        case rr of
          0..17: if (g_Config.tiWeaponDCAddRate <> 0) and (Random(_Max(1, g_Config.tiWeaponDCAddRate - bLevel)) = 0) then begin
          ...
          18..33: if (g_Config.tiWeaponMCAddRate <> 0) and (Random(_Max(1, g_Config.tiWeaponMCAddRate - bLevel)) = 0) then begin
          ...
          34..49: if (g_Config.tiWeaponSCAddRate <> 0) and (Random(_Max(1, g_Config.tiWeaponSCAddRate - bLevel)) = 0) then begin
          ...
          50..59: if (g_Config.tiWeaponLuckAddRate <> 0) and (Random(_Max(1, g_Config.tiWeaponLuckAddRate - bLevel)) = 0) then begin
          ...
          60..69: if (g_Config.tiWeaponCurseAddRate <> 0) and (Random(_Max(1, g_Config.tiWeaponCurseAddRate - bLevel)) = 0) then begin
          ...
          70..79: if (g_Config.tiWeaponHitAddRate <> 0) and (Random(_Max(1, g_Config.tiWeaponHitAddRate - bLevel)) = 0) then begin
          ...
          80..89: if (g_Config.tiWeaponHitSpdAddRate <> 0) and (Random(_Max(1, g_Config.tiWeaponHitSpdAddRate - bLevel)) = 0) then begin
          ...
          90..99: if (g_Config.tiWeaponHolyAddRate <> 0) and (Random(_Max(1, g_Config.tiWeaponHolyAddRate - bLevel)) = 0) then begin
  ...
  try
    if n >= 0 then begin
      for i := 0 to 3 do begin
        rr := Random(100);
        case rr of
          0..29: if (g_Config.tiWearingDCAddRate <> 0) and (Random(_Max(1, g_Config.tiWearingDCAddRate - bLevel)) = 0) then begin
          ...
          30..59: if (g_Config.tiWearingMCAddRate <> 0) and (Random(_Max(1, g_Config.tiWearingMCAddRate - bLevel)) = 0) then begin
          ...
          60..89: if (g_Config.tiWearingSCAddRate <> 0) and (Random(_Max(1, g_Config.tiWearingSCAddRate - bLevel)) = 0) then begin
          ...
          90..99: if stdMode in [19, 20, 21, 23, 24] then begin //特殊首饰
              if stdMode = 19 then begin
                for ii := 0 to 1 do begin
                  rrr := Random(2);
                  case rrr of
                    0: if (g_Config.tiWearingAntiMagicAddRate <> 0) and (Random(_Max(1, g_Config.tiWearingAntiMagicAddRate - bLevel)) = 0) then begin
                    ...
                    1: if (g_Config.tiWearingLuckAddRate <> 0) and (Random(_Max(1, g_Config.tiWearingLuckAddRate - bLevel)) = 0) then begin
                ...
                for ii := 0 to 1 do begin
                  rrr := Random(2);
                  case rrr of
                    0: if (g_Config.tiWearingHitAddRate <> 0) and (Random(_Max(1, g_Config.tiWearingHitAddRate - bLevel)) = 0) then begin
                    ...
                    1: if (g_Config.tiWearingSpeedAddRate <> 0) and (Random(_Max(1, g_Config.tiWearingSpeedAddRate - bLevel)) = 0) then begin
                ...
                for ii := 0 to 1 do begin
                  rrr := Random(2);
                  case rrr of
                    0: if (g_Config.tiWearingHealthRecoverAddRate <> 0) and (Random(_Max(1, g_Config.tiWearingHealthRecoverAddRate - bLevel)) = 0) then begin
                    ...
                    1: if (g_Config.tiWearingSpellRecoverAddRate <> 0) and (Random(_Max(1, g_Config.tiWearingSpellRecoverAddRate - bLevel)) = 0) then begin
              ...
              for ii := 0 to 1 do begin
                rrr := Random(2);
                case rrr of
                  0: if (g_Config.tiWearingACAddRate <> 0) and (Random(_Max(1, g_Config.tiWearingACAddRate - bLevel)) = 0) then begin
                  ...
                  1: if (g_Config.tiWearingMACAddRate <> 0) and (Random(_Max(1, g_Config.tiWearingMACAddRate - bLevel)) = 0) then begin
