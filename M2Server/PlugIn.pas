...
uses
  EngineType, Windows, Classes, SysUtils, Forms, Grobal2, SDK;
...
type
  ...
  pTPlug  = ^TPlug;
TGetScriptText    = function(Msg:PChar;LoMsg:PChar;LoMsgLen:Integer):integer;stdcall; //加载脚本加解密插件 Development 2019-02-03
...
begin
  ...
  if ProcName='PlugOfScript' then begin
     PlugScript:=ProcAddr;
  end;
end;
